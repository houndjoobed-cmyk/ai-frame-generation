    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 py-20 px-4 max-w-4xl mx-auto w-full">
        ...
        <div className="mb-16 text-center text-muted-foreground font-light leading-relaxed max-w-2xl mx-auto">
          ...
          <p>
            Découvrez nos postes ouverts ci-dessous ou envoyez-nous une candidature spontanée à <span className="font-semibold text-rose-500">jobs@eventframes.com</span>.
          </p>
        </div>
