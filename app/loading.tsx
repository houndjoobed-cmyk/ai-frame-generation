      ...
      >
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] tracking-[0.2em] font-medium text-zinc-500 uppercase">
              PORTFOLIO LOADER
            </span>
          </div>
        </div>
        ...
        <div className="mt-8 relative z-10">
          ...
          <div className="w-full h-2 bg-zinc-900/90 rounded-full border border-zinc-800/30 overflow-hidden shadow-inner">
            ...
            <motion.div
              className="h-full bg-gradient-to-r from-rose-600 via-rose-500 to-rose-400 shadow-[0_0_12px_rgba(244,39,94,0.5)]"
